        ...
        mockMvc.perform(builder)
                ...
                .andDo(document("get-user-posts",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("body[].likers[].image.src").type(JsonFieldType.STRING).description("profile image src of likers").optional(),
                                ...
                                fieldWithPath("body[].retweet.images").description("retweet images"),
                                fieldWithPath("body[].retweet.images[].src").description("retweet images src"),
                                fieldWithPath("body[].retweet.likers").description("retweet likers"),
                                fieldWithPath("body[].retweet.commentNum").description("commment number of retweet"),
